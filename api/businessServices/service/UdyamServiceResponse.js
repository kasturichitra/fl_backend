...
const udyamActiveServiceResponse = async (
  ...
  businessServiceLogger.info(
    `[udyamActiveServiceResponse] Trying service with priority ${index + 1}:`,
    newService,
  );
    ...
    case "INVINCIBLE":
      returnedObj = {
        ...
        "Official address of Enterprise": {
          ...
          "Village/Town":
            obj?.result["Official address of Enterprise"]?.["Village/Town"] ||
            null,
          Block:
            obj?.result["Official address of Enterprise"]?.["Block"] || null,
          "Road/Street/Lane":
            obj?.result["Official address of Enterprise"]?.[
              "Road/Street/Lane"
            ] || null,
          ...
          State:
            obj?.result["Official address of Enterprise"]?.["State"] || null,
          District:
            obj?.result["Official address of Enterprise"]?.["District"] || null,
          Mobile:
            obj?.result["Official address of Enterprise"]?.["Mobile"] || null,
          Email:
            obj?.result["Official address of Enterprise"]?.["Email"] || null,
        },
      };
      break;
    case "TRUTHSCREEN":
