...
const IecActiveServiceResponse = async (data, services = [], index = 0, TxnID = "") => {
    ...
    if (!newService) {
        ...
        return IecActiveServiceResponse(data, services, index + 1, TxnID);
    }
...
const IecApiCall = async (data, service, TxnID = "") => {
